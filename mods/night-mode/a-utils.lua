...
local string_format,table_insert,mod_storage_load,math_clamp,math_round,set_fog_color,set_lighting_color,set_vertex_color,level_is_vanilla_level,gfx_get_from_name,gfx_get_display_list,gfx_get_command,gfx_get_vertex_buffer,vtx_get_next_vertex,gfx_get_op,gfx_get_next_command,math_lerp,spawn_non_sync_object,obj_set_face_angle = string.format,table.insert,mod_storage_load,math.clamp,math.round,set_fog_color,set_lighting_color,set_vertex_color,level_is_vanilla_level,gfx_get_from_name,gfx_get_display_list,gfx_get_command,gfx_get_vertex_buffer,vtx_get_next_vertex,gfx_get_op,gfx_get_next_command,math.lerp,spawn_non_sync_object,obj_set_face_angle
