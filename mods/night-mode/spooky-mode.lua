...
local bhv_mad_piano_update,cur_obj_init_animation_with_sound,cur_obj_push_mario_away_from_cylinder,obj_get_nearest_object_with_behavior_id,dist_between_objects,cur_obj_hide,audio_stream_pause,fade_volume_scale,cur_obj_unhide,audio_stream_play,math_clamp,audio_stream_set_volume,set_mario_action,sound_banks_disable,audio_stream_stop,level_trigger_warp,smlua_anim_util_set_animation,audio_stream_set_looping,sound_banks_enable,audio_sample_play,djui_hud_set_resolution,djui_hud_set_filter,djui_hud_get_screen_width,djui_hud_get_screen_height,djui_hud_set_color,string_format,djui_hud_render_texture,djui_hud_render_rect = bhv_mad_piano_update,cur_obj_init_animation_with_sound,cur_obj_push_mario_away_from_cylinder,obj_get_nearest_object_with_behavior_id,dist_between_objects,cur_obj_hide,audio_stream_pause,fade_volume_scale,cur_obj_unhide,audio_stream_play,math.clamp,audio_stream_set_volume,set_mario_action,sound_banks_disable,audio_stream_stop,level_trigger_warp,smlua_anim_util_set_animation,audio_stream_set_looping,sound_banks_enable,audio_sample_play,djui_hud_set_resolution,djui_hud_set_filter,djui_hud_get_screen_width,djui_hud_get_screen_height,djui_hud_set_color,string.format,djui_hud_render_texture,djui_hud_render_rect
